...
export function NavigationTabBar({ state, descriptors, navigation }) {
    ...
    const icon = {
        Home : (props) => <FontAwesomeIcon icon={faHouse} size={20} color={props.color} />,
        Chats : (props) => <FontAwesomeIcon icon={faMessage} size={20} color={props.color} />,
        CreateTrips : (props) => <FontAwesomeIcon icon={faLocationArrow} size={30} color={props.color} />,
        MyTrips : (props) => <FontAwesomeIcon icon={faMap} size={20} color={props.color} />,
        Profile : (props) => <FontAwesomeIcon icon={faUser} size={20} color={props.color} />,
    }
